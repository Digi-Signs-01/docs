...
By default, the Digisigns Players are designed to always be connected, so whenever there is any content update, all connected Players will immediately synchronize and download the updated content.
