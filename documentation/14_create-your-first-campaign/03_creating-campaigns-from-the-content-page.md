...
6. You’ll be redirected to the Campaign editor page. Now, you can edit other preferences, such as [Screen Layout](06_how-to-create-custom-screen-layouts.md), adjust each file's length, [add Apps](../04_apps/02_creating-an-app.md), and more.  
