...
1. In your Digisigns account, go to your "Content" page
...
3. You'll be redirected to the Campaign editor page. The tools for setting up a Campaign are the Campaign Info area, [Screen Layout](06_how-to-create-custom-screen-layouts.md), [Timeline](07_how-to-use-the-timeline.md) (where you insert the media you want to display in each of the different screen regions and in a specific order), and the Content area at the bottom which mirrors your Content structure.  
...
## Digisigns Academy - Campaigns and Screen Layouts
