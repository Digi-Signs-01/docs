...
Once you have created your own App, please follow these steps to upload and import it to Digisigns:

1. **Compress all files** and Assets used by your App **into a ZIP** file.
2. **Upload the ZIP** file to your Digisigns account folder structure.
3. Once uploaded, Digisigns will expand your ZIP file.
