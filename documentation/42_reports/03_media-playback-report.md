...
Besides tracking Content Playback, Digisigns also makes it possible to track individual playback of every media presented by every Player.
...
4. **Enable "Media reporting"**. If you want to generate media reports across your network, then adjust this in the [Player Default Settings](../34_player-settings/03_configuring-multiple-players.md), instead of in an individual Players's Settings.  
...
4. Set a beginning and end date for your Report. You can create single or [recurring Reports](01_creating-scheduled-reports.md).
...
Once a Report is started, you can load other pages as there is no need to wait for it to be completed. To avoid keeping you waiting, we recommend entering your email in the notification field, so the Digisigns platform will send you a message once the Report is ready to be downloaded.
