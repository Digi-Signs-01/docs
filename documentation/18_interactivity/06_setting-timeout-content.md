...
When you are not sure about how long the Campaign should last, then it is better to publish longer Campaigns and set a Timeout on the Interactivity. The Digisigns  Player App will detected when no one has interacted with the Content for a certain period of time previously defined by you and trigger another Content automatically.
...
Learn how to [create interactive Campaigns](04_create-interactive-campaigns.md).

1. In your Digisigns account, right-click on the interactive Campaign where you want to set the Timeout.
...
5. Adjust how many seconds should pass without any interaction before Digisigns triggers the main Content.
...
## Digisigns Academy - Keyboard and Local Network Interacticity
