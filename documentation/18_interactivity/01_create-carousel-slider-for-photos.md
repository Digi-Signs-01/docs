...
1. In your Digisigns account, create a Campaign. Fill out the basic info, such as name and category.
...
3. Upload the images you are going to use in this specific Campaign to your Digisigns account. In your Timeline, place the buttons in their respective screen zone and place the background image and a single photo of the carousel.  
