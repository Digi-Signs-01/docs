...
Supported on the Digisigns  Player App for Android 4.2.0+ and Windows App 9.1.1+
...
1. **Tip:** When creating your own Campaign, make a paper sketch before even opening your Digisigns account . Plan in advance:  
...
3. Upload all files to your Digisigns Account.  
...
7. Add a completely transparent image to these new areas in your Timeline to be able to save the Campaign. Digisigns does not allow you to save a Campaign with empty timelines. The button’s text will be readable beneath the transparent image.  
   The transparent image must be in the PNG format ([learn more about transparency](../25_media/13_transparent-image-background.md)).  
...
## Digisigns Academy - Touch Screen Interactivity
