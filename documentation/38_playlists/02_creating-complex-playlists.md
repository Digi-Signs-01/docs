...
In this tutorial, we explore another use of Playlists which, combined with [Campaign Cycling](01_campaign-cycling.md), will make your digital signage even more dynamic.

You already know the benefits of publishing Playlists instead of Content one by one to a Player and [how to create them](../08_basics-playlist/03_creating-a-playlist.md). You simply group your Content into the desired loop.
...
2. Fill out the basic details, such as Name and the optional Category or Tags. Choosing the Playback Mode [Campaign or Item Cycling](01_campaign-cycling.md) is optional.
