...
Dynamic content is perhaps one of the most important aspects for signage screens. While Digisigns for sure can handle RSS, Facebook, Instagram, and other feeds, what if:
...
Think of a Data Feed as a spreadsheet where each column is a field which can be used by Data Feed [enabled Apps](08_using-apps-to-display-a-data-feed.md). Once created, a Data Feed will look like this:
