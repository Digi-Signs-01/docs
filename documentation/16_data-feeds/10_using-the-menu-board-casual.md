...
This App gets its contents from a [Data Feed](02_creating-a-new-data-feed.md). The App tells us the required information. Except for the item name, all other entries are optional.
...
This can be a manual Data Feed on the Digisigns platform or an outside source like CVS, Google Sheets, and so on. We create a Manual Data Feed.
