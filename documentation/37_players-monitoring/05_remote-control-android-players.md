...
Control your Android Player through your [Digisigns account](https://app.onsign.tv/device/).

Besides [remotely viewing the Player](07_remote-view.md), you can even control it through the same page on your Digisigns account. With this feature, you can access Apps and change settings.

1. Click on the Player tab on your Digisigns account and choose a device. This feature requires a rooted Android Player or with an installed System App ([SPM](https://onsign.tv/spm/)).
...
4. After completing your task, do not forget to open the Digisigns  Player App before leaving the remote view page!
