...
Digisigns provides a complete Dashboard to keep track of your entire signage network at one glimpse. You can access your this panel by logging into your Digisigns account and clicking on the Dashboard tab on the left. It's that easy.
...
At the bottom of the page, Digisigns ranks the Players with most errors and warnings so you can quickly spring into action.
...
2. You can also use the search box to filter Players. Type in the following to limit the data shown:
   ...
   - **version:"Android 10.2.1"** – Display all devices with this version of the Digisigns  Player App installed.
