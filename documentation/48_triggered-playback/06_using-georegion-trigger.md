...
We have shown you [how to set up GeoRegions](05_setting-georegions.md) in a previous tutorial for reference. In this tutorial you now learn how to set the trigger to your Content.
...
5. If you don't have the region set up to your needs yet, you need to set up a new region or modify the existing one, click on the "Manage Geographic Regions" button and follow the steps [to set a GeoRegion](05_setting-georegions.md).
