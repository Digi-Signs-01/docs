...
Combine two Digisigns tools – QR code App and on-demand publishing – to let viewers interact with your products and content!
...
When scanning the QR code, Digisigns will trigger related Content on the display, besides also triggering a web page on the cellphone browser.

## Step-by-step

1. Create Content with the additional info you wish to trigger.
2. Save & Publish as [on-demand](04_playing-on-demand-content.md). It is possible to set a web page which will trigger on the user's cellphone (_optional_).  
...
5. Add the copied on-demand URL to the QR code App ([learn how to create QR code App here](../39_popular-apps-setup/09_using-qr-codes.md)).  
