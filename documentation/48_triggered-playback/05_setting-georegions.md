...
Digisigns offers features to trigger and limit Content playback to GeoRegions. For example Content can be triggered when crossing a geographic delimitation. For this purpose, you need to define the areas beforehand.

1. In your Digisigns account, select "[Geographic Regions](https://app.onsign.tv/geographic-regions/)" from the menu.  
...
5. You can already set this region to play back a [triggered Content](06_using-georegion-trigger.md). Create as many regions as you need. To create new GeoRegions click on the "New" button and repeat the process.

## Digisigns Academy - Geo Regions and Location Based Playback
