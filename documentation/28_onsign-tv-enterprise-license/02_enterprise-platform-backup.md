...
The Digisigns Enterprise plan includes a comprehensive and robust solution for protecting your data. In addition to other security features, Digisigns executes an extensive platform backup of all data. This is part of the Digisigns Business Continuity Plan, so we can ensure minimal to no data loss in case of a severe disaster taking place.

### Digisigns Enterprise backup employs the following strategies:
