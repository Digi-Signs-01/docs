...
2. Create or edit a Campaign in your Digisigns account.
3. In the "Screen Layout" section of the Campaign editor, click “Add Custom Layout”.
4. Add the [Screen Divisions](../14_create-your-first-campaign/06_how-to-create-custom-screen-layouts.md) which will fit the Content you want to add. At last, create an overlapping layer for the transparent image (Zone B of the image below).  
...
6. [Upload](07_how-to-upload-media-files.md) the **.png** file and drag it from your Content library to the overlapping zone’s Timeline ruler.  
