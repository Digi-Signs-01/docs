...
As your digital signage operation grows, Folders are helpful to organize Content in accordance with your own structure. Combine this tool with [Content Tags](../14_create-your-first-campaign/08_organizing-campaigns-with-tags.md) and never take long searching for a specific item!

1. Click on the “New” button on the Content page of your Digisigns account, followed by selecting "Folder" from the pop-up menu.  
...
To delete a Folder, right-click the Folder and hit "Delete". Digisigns may request you to confirm the action by writing "DELETE" if there are files in use inside the selected Folder.
...
## Digisigns Academy - Managing your Content in Folders
