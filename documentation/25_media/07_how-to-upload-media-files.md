...
Photos, videos, and other media types are essential to create effective Content which captivates the viewers' attention. Learn how to upload media files to your Digisigns platform before or during the content creation process.

1. In your Digisigns account, go to "Content" on the left sidebar menu. Hit the orange "New" button on top and select "Upload File" from the drop-down menu.
...
An even simpler way to upload is to use the drag and drop feature. Simply select the file on your computer, drag it over the Digisigns content library and drop it there.
...
3. Select the files on the pop-up window.  
   **Alternative:** If you prefer, you can also drag the files from your computer map straight to the Digisigns page. As you hold the photo or video over the content library, the message "drop your files here to upload them" will show up.
