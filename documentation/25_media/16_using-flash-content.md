...
The Windows version of the Digisigns  Player App supports ".swf"-files, but requires installation of the Adobe Flash Player. Learn how to download below:
...
6. After the installation is complete, your Flash files will work properly on your Digisigns Windows Players.  
