...
Digisigns provides different Apps in table format. Get to know the different types below and how to create them:

1. To view all available Table & Sports App templates, go to the App Library of your Digisigns platform ([Creating an App](../04_apps/02_creating-an-app.md)).
