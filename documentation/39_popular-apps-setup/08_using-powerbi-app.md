...
Digisigns can be used to present PowerBI dashboards and reports directly on your signage screens. Better yet, access to the PowerBI platform is directly authenticated through your Microsoft account, so your password is not stored on Digisigns.
...
1. Authenticate Digisigns on your Microsoft Account:
   - In your Digisigns account, go to Settings > Integration Accounts
   - Click the orange button "**+ Add Account**" on the top-right
   - Select **Add Microsoft Account**
   - Authorize Digisigns to access your Microsoft PowerBI Account  
