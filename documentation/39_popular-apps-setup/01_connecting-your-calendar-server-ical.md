...
2. In the list of all available calendars, hover over the three dots next to the calendar you would like to link to Digisigns. Then click Settings and sharing.  
...
4. Copy the calendar address and enter it into the Digisigns [Calendar App](https://onsign.atlassian.net/wiki/spaces/OTT/pages/32342143).
...
7. You will see two links. Copy the link which finishes with ".ics" and enter it into the Digisigns [Calendar App](13_using-the-calendar-app.md).  
