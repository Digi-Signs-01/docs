...
1. In your Digisigns account, select the "Content" tab.
...
5. Fill out all available options according to your preferences:  
   ...
   - **Calendar URL (iCal):** Your events are synchronized from an iCal calendar. This file format is supported by a large number of providers, including Apple and Google. In this field, you need to provide your calendar's URL. Refer to this tutorial to learn [how to connect your calendar](01_connecting-your-calendar-server-ical.md).
