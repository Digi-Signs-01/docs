...
The name and date information source can be a Google Sheet or a [Data Feed](../16_data-feeds/README.md). One Birthday App can be fed with a Google Sheet alone, several other designs take data from a Data Feed.
...
Now, we will leave the Google Drive aside and go back to your Digisigns account.
