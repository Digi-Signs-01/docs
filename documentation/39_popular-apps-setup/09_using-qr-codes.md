...
This is how to set up the Digisigns **QR Code App**:
...
3. Choose the “QR Code” App and fill out the following info:  
   ...
   - **App name:** Simply name the App anything you like. By this name you find the App among your Digisigns Content.
