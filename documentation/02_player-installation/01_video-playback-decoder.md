...
- Digisigns [Windows Players](/Windows)
- Digisigns [Linux](/Linux)
- Digisigns [macOS](/Macos)

**Note** – Only change this settings in case you are experiencing Player crashes or video playback instability.

Digisigns can use different Video playback strategies and this will change the path video decoding and rendering is executed. By default, the Automatic option will be selected and Digisigns will select the best option based on your graphic card and video driver version.
