...
2. Navigate to the Digisigns Player icon (if never moved, it can be hidden outside the screen on the far right of the app drawer);
...
To reinstall our App, you can follow the steps from [this tutorial](02_installing-on-webos-20-to-32.md).
