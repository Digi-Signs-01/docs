...
- **webOS 3.2** – SM5D, SM5KD, EG5CD and EJ5D (Compatible with [firmware 04.00.60](08_updating-lg-webos-firmware.md) or newer).
...
If you wish to set up Digisigns on LG webOS 4.0 or higher, [check out this tutorial](03_installing-on-webos-40-to-60.md).
...
- Application Type: **IPK\*** (\*If this option is **not available, it means you need to upgrade the TV's firmware**. Upgrade the firmware and re-start the Digisigns installation process.)
- Portrait Mode: On **LG webOS 3**, you can set the display orientation directly in this menu. Make sure your device has the latest firmware, or at least 04.21.10. (To set LG webOS 2 devices to portrait, you need to follow the instructions of [this tutorial](05_rotating-screen-on-webos-20.md).)
