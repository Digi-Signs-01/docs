...
This tutorial will guide you through the installation process of the Digisigns  Player App on Samsung Smart Signage Platform devices of the 2nd and 3rd generation. These devices can only run the OnSign player app up to version 3.3.x.

Learn how to install Digisigns on newer [Samsung Tizen Screens](03_installing-tizen-player-software.md).

Requirements

Besides having an Digisigns account, you need a 2nd or 3rd generation Samsung Smart Signage Platform LFD (Large Format Display). Once you have the device in hands, you need to determine its current state:
...
To install the Digisigns  Player, follow the steps below:
...
The Digisigns Player for Samsung Smart Signage Platform devices will be automatically installed into your LFD. Your display may restart one or more times during the setup process.
...
To uninstall the Digisigns  Player or any other URL Launcher software running on your LFD, follow the steps below:
