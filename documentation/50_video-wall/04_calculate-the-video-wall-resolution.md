...
For a single Full HD screen (1920 x 1080px), you only need to create a Campaign and adjust the layout to your needs. In the case of a Video Wall, you have to sum up the width and height of all screens and create a [Custom Layout](../14_create-your-first-campaign/04_custom-resolution-to-match-your-display.md) with the resolution of the sums of the two sides.
