...
Digisigns allows you to define a Master Player to synchronize Content playback on multiple screens.
...
1. Create a [Player Group](01_how-to-create-player-groups.md).
