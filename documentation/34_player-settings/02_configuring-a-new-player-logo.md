...
Every time you associate a new Player to the Digisigns account, it will display the Digisigns logo above the “No campaign available” message.
...
You can change the logo any time by uploading a new one. You can also get back to the Digisigns logo by clicking on the red button "Remove Logo".

Use the [Default Player Settings](06_player-default-settings.md) to configure a custom logo for all new Players or [to apply](03_configuring-multiple-players.md) a custom logo to all existing Players.
