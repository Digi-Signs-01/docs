...
By default, your Digisigns account tries to use your Player's GPS, Wi-Fi or IP address to determine its location. But especially for offline Players, this information is not readily available. Luckily, you can determine your Player's location in your account.

1. Go to the "Players" tab in your Digisigns account and select the corresponding Player whose location you want to set.
