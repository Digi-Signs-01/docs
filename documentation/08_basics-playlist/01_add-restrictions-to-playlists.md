...
This tutorial will show you how to add a restriction to a piece of content in a Playlist. It is different from [adding a restriction to Content which shall apply to all Players](../09_basics-publishing/01_adding-restrictions-to-content.md) and it is also different from [setting a restriction at publishing to a Player](../09_basics-publishing/02_basic-content-publishing.md).

1. Select a Playlist from your Digisigns account.
