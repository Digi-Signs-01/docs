...
1. Go to the Content page of your Digisigns account. Click on "New" and then select the option "Playlist".  
...
3. In the info box you can also set the Folder to which the Playlist will be saved, set Categories and Tags as needed. You can also set a default duration for images added to the Playlist Loop. The initial setting is to 10 seconds, but you can modify it to your preference, as well as [adjust particular durations](02_adding-files-media-and-apps-to-a-playlist.md) for individual images in the Playlist Content box further below.  
