...
Your Digisigns subscription is charged automatically on a monthly or annual basis. Each payment is saved in the billing history in the Subscription section. If you need a receipt, you can download and print an invoice file through the platform.

Learn how to download an invoice:

1. In your Digisigns account, click on your username in the bottom-left corner. Then select Subscription.  
