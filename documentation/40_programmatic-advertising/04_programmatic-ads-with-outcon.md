...
Configuring the Outcon App follows the same process as any other Digisigns content application.
...
Digisigns can provide two different reports for the Outcon App:
