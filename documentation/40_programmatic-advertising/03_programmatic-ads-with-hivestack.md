...
## Hivestack Digisigns Integration
...
This tutorial describes how to integrate Digisigns Screens with Hivestack.
...
**IMPORTANT** - Programmatic integration \***\*will not work\*\*** in case the Digisigns App is outdated, or in case the SoC firmware is not matching the requirements.
...
Configuring the Hivestack App follows the same process as any other Digisigns content application.
...
Digisigns can provide two different reports for the Hivestack App:
...
In addition to the [OnSign firewall settings](../27_network-settings/01_firewall-settings.md), please ensure the following domains can be accessed from each player that needs to present Hivestack programmatic Ads:
