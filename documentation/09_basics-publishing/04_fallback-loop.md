...
1. On the Content page of your Digisigns account, right-click on the Content and select “Publish” from the pop-up menu.
...
1. Underneath the “How to Play It” box, select “Play on Fallback Loop”.  
   ![](https://static.helpjuice.com/helpjuice_production/uploads/upload/image/23821/direct/1731692297729/fallback-loop_3.png)
1. Within Fallback Loop, you can also set Playback Restrictions which have the Content play during a period of time or within specific regions like you would with any other Content.
1. When done, confirm with “Publish”.
1. To view your Fallback Loop, click on the Players tab. Select the Player to which you have published the Content, then select “Content in Players” from the sidebar menu. The "Fallback Loop" list is right under the list of the “Primary Loop”.  
