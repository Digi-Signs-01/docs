...
1. In your Digisigns account, go to the Players tab on the left and select the device you want to publish new Content to.  
...
3. On the newly loaded page, click on the magnifying glass icon to search. Type in a [Tag you have set on some of your Content](../14_create-your-first-campaign/08_organizing-campaigns-with-tags.md) in the search field and klick enter. For this tutorial, we chose to publish several pieces of Content using the Tag "test", "test1", and "test2" to a Player.  
