...
Share content from the staples of social media with your audience. Digisigns has many social networks in its App library. Learn how to add them to your Content:

1. First, you go to the App gallery ([Creating an App](../04_apps/02_creating-an-app.md)) where you create, edit, or use any App template.
...
In light of this situation, we propose exploring alternative solutions such as Social Media aggregation companies like [http://Walls.io](http://walls.io/), which can be effectively utilized alongside Digisigns.

We recommend unpublishing all of the Twitter Apps from your Digisigns account, as they will no longer have their content updated.
