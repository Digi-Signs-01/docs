...
1. On the Content page of your Digisigns account, click on the "New" button and select App to get to the App Gallery ([Creating an App](../04_apps/02_creating-an-app.md)).
...
For streaming YouTube videos, please use the [YouTube Video App](09_using-youtube-video-app.md) from the Social Networks App category.
