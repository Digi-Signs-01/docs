...
1. Click on your username on the bottom-left corner in your Digisigns account. Then, select “Settings” from the menu.
...
Often in larger organizations, accounting staff needs to receive invoices, but they don't need to have an Digisigns account to manage Content. In this case, you can add additional email address to receive invoices right in the billing section of your account.
